...
//	}
	...
	private JLabel getLblOrderCode() {
		if (lblOrderCode == null) {
			...
			lblOrderCode.setBounds(81, 115, 124, 20);
		}
		return lblOrderCode;
	}
	...
	private JTextField getTxtCode() {
		if (txtCode == null) {
			...
			txtCode.setBounds(239, 112, 86, 23);
...
//					System.exit(0); // to end the app if you click on cancel
	...
	private JLabel getLblMessage() {
		if (lblMessage == null) {
			...
			lblMessage.setBounds(94, 39, 308, 45);
		}
		return lblMessage;
	}
	...
	private JLabel getLblPrice() {
		if (lblPrice == null) {
			...
			lblPrice.setBounds(81, 148, 46, 21);
		}
		return lblPrice;
	}
	...
	private JTextField getTxtPrice() {
		if (txtPrice == null) {
			...
			txtPrice.setBounds(239, 146, 86, 23);
